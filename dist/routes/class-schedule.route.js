 ...
 *                       example: 2
 */
router.post('/create', auth_middleware_1.authenticateJWT, (0, role_middleware_1.roleMiddleware)('ADMIN'), class_schedule_controller_1.createClassSchedule);
/**
 * @swagger
 * /class-schedule/list:
 *   get:
 ...
 *                       example: 2
 */
router.put('/update/:id', auth_middleware_1.authenticateJWT, (0, role_middleware_1.roleMiddleware)('ADMIN'), class_schedule_controller_1.updateClassSchedule);
/**
 * @swagger
 ...
 */
router.delete('/delete/:id', auth_middleware_1.authenticateJWT, (0, role_middleware_1.roleMiddleware)('ADMIN'), class_schedule_controller_1.deleteClassSchedule);
